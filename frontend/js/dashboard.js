    ...
    posts.forEach(post => {
      ...
      card.innerHTML =
        '<div class="post-header">' +
          ...
          '<div>' +
            '<div class="post-author"><a href="user.html?id=' + post.author.id + '">' + post.author.name + '</a></div>' +
    ...
    people.forEach(person => {
      ...
      card.innerHTML =
        '<div class="feed-card-top">' +
          ...
          '<div class="feed-name"><a href="user.html?id=' + person.user.id + '">' + person.user.name + '</a></div>' +
          badgeHTML +
        '</div>' +
